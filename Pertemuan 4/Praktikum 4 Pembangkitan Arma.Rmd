...
author: "Aida Darajati - G1401211016"
date: "2023-09-21"
...
Akan dicoba membangkitkan proses MA paling sederhana, yaitu MA(2) dengan $\theta_1 = 0.4$ sebanyak 300 observasi dan $c=0$. Karena diperlukan satu nilai awal untuk $e_{t-1}$ dan $e_{t-2}$, masukkan nilai pertama white noise sebagai nilai awal tersebut.
...
Dari keempat plot tersebut, terlihat bahwa data berpola stasioner.
...
Korelasi antara $Y_t$ dengan $Y_{t-1}$ dari hasil simulasi mendekatai perhitungan teoritis, yaitu
...
Korelasi antara $Y_t$ dengan $Y_{t-3}$ dari hasil simulasi mendekati perhitungan teoritis yaitu $\rho_1=\frac{\phi_1^3+\phi_1\phi_2}{1-\phi_2}+\phi_1\phi_2=\frac{0.5^3+(0.5)(0.2)}{1-0.2}+(0.5)(0.2)=0.38125$
