...
Berdasarkan hasil DW Test, didapatkan nilai $DW = 1.1122$ dan *p-value* = $0.0000149$. Berdasarkan tabel Durbin-Watson diperoleh nilai $DL = 0.9771$ dan $DU = 1.331$. Dengan nilai *p-value* \< 0.05 dapat disimpulkan bahwa tolak H0, cukup bukti mengatakan adanya autokorelasi. Oleh karena itu, diperlukan penanganan autokorelasi. Penanganan yang akan digunakan menggunakan dua metode, yaitu Cochrane-Orcutt dan Hildret-Lu.
...
minimum. Pada hasil di atas terlihat $ρ$ minimum ketika 0.6. Namun,
...
optimum, yaitu saat SSE terkecil terdapat pada nilai $ρ=0.500$. Hal
...
Hildreth-Lu sebagai berikut. $$y_i=17.67857+0.47628x_1+0.01142x_2+0.08331x_3--0.03437x_4$$
...
Hasil uji Durbin-Watson juga menunjukkan bawah nilai DW sebesar $1.4925$
berada pada selang daerah tidak ada autokorelasi, yaitu pada rentang DU
\< DW \< 4-DU. Hal tersebut juga didukung oleh
*p-value* sebesar $0.01578$, di mana *p-value* \> $\alpha$=5%. Artinya
