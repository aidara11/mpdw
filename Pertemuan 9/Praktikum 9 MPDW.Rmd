...
## Plot Data Uji
```{r}
inflasitest <- datainflasi.ts[175:249]
...
Didapatkan nilai MAPE sebesar 32.58989 (antara 20%-50%) yang menandakan bahwa hasil peramalan dari model ARIMA(0,1,2) cukup baik. Prediksi ini mungkin masih dapat digunakan, tetapi memerlukan perbaikan.
